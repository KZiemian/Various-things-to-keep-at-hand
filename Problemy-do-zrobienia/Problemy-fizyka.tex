...
% ######################################
\section{Kinematyka relatywistyczna, problemy do zrobienia}
...
\item W~układzie CM czteropęd cząstki $A$ ma składowe $[ E / c, p, 0, 0 ]$,
  a~cząstki $B$ ma składowe $[ E / c, -p, 0, 0 ]$, gdzie
  $E = \sqrt{ p^{ 2 } c^{ 2 } + m^{ 2 } c^{ 4 } }$. Znajdź składowe czteropędu
  cząstki $A$ w~układzie, w~którym czteropęd cząstki $B$ ma składowe
  $[ mc, 0, 0, 0 ]$.
